# Clinical Record Registration and Control System

Full-stack application for a **Clinical record registration and control system** for general medical care, built with **ASP.NET Core 8** (backend) and **Vite + React 18 + TypeScript** (frontend), following **Clean Architecture** principles.
